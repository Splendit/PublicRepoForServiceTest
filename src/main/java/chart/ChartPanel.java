...
public class ChartPanel extends JPanel implements ChartChangeListener, ChartProgressListener, ActionListener,
	 ...
	 *            (read the warning above before setting this to {@code false}).
	 */
	 ...
	 *            be available via the popup menu.
	 * @param copy
	 *            a flag indicating whether or not a copy option should be available
	 *            via the popup menu.
	 * @param save
	 *            a flag indicating whether or not save options should be available
	 *            via the popup menu.
	 ...
	 *
	 * @param popup
	 *            the popup menu ({@code null} permitted).
	 */
	 ...
	 *
	 * @param flag
	 *            {@code true} enables zooming and rectangle fill on zoom.
	 */
	 ...
	 *
	 * @param flag
	 *            {@code true} if zooming enabled
	 * @param fillRectangle
	 *            {@code true} if zoom rectangle is filled, false if rectangle is
	 *            shown as outline only.
	 */
	 ...
	 *
	 * @param flag
	 *            {@code true} instructs to fill the rectangle on zoom, otherwise it
	 *            will be outlined.
	 */
	 ...
	 *
	 * @param directory
	 *            the directory ({@code null} permitted).
	 *
	 * @since 1.0.7
	 */
	 ...
	 *
	 * @param flag
	 *            {@code true} to enable tooltips, {@code false} to disable
	 *            tooltips.
	 */
	 ...
	 *
	 * @param screenPoint
	 *            the screen location ({@code null} not permitted).
	 *
	 ...
	 *
	 * @param flag
	 *            {@code true} indicates that the buffer should be refreshed.
	 */
	 ...
	 * @param pageIndex
	 *            the index of the page. If not {@code 0}, nothing gets printed.
	 *
