...
public class BorderPainter implements Drawable, Serializable {
	...
	public void draw(Graphics2D g2, Rectangle2D area) {
		...
		if (this.arcHeight > 0.0 && this.arcWidth > 0.0) {
			border = new RoundRectangle2D.Double(0, 0, 0, 0, this.arcWidth, this.arcHeight);
		} else {
	...
	public int hashCode() {
		...
		hash = 83 * hash
				+ (int) (Double.doubleToLongBits(this.arcHeight) ^ (Double.doubleToLongBits(this.arcHeight) >>> 32));
		hash = 83 * hash
				+ (int) (Double.doubleToLongBits(this.arcWidth) ^ (Double.doubleToLongBits(this.arcWidth) >>> 32));
		return hash;
	}
